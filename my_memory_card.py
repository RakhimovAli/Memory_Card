...
questions_list.append(Question('Что лишнее?','Огурец','Банан','Яблоко','Грейпфрут')) 
questions_list.append(Question('Сколько будет 5+5','10','7','11','9')) 
questions_list.append(Question('Сколько будет 5*10','50','45','30','55')) 
questions_list.append(Question('Город Нижний Новгород в какой стране находится?','Россия','США','Китай','Япония'))
